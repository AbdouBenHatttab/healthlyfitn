...
// import com.healthapp.doctor.validator.DoctorEmailValidator;
// import com.healthapp.shared.enums.Gender;
// import jakarta.validation.constraints.*;
// import lombok.AllArgsConstructor;
// import lombok.Builder;
...
//     // ✅ Email DOIT se terminer par @doctor
//     @NotBlank(message = "Email is required")
//     @Email(message = "Invalid email format")
//     @DoctorEmailValidator  // ✅ Validation personnalisée
//     private String email;
...
public class DoctorRegisterRequest {
    ...
    // ✅ Email DOIT se terminer par @doctor.xxx
    @NotBlank(message = "Email is required")
    @Email(message = "Invalid email format")
    @Pattern(
        regexp = "^[\\w.%+-]+@doctor\\.[a-zA-Z]{2,}$",
    ...
    @Pattern(
        regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&.])[A-Za-z\\d@$!%*?&.]{8,128}$",
        message = "Password must contain: 1 lowercase, 1 uppercase, 1 digit, 1 special character"
    )
    private String password;
